...
<template>
  <div class="w-3/6 relative">
    <input
      v-model="searchValue"
      type="text"
      class="outline-none w-full border border-gray-400 rounded-sm px-3 text-lg font-semibold py-2"
      placeholder="Find an item"
      @keydown.enter="search"
    />
    <button @click="search" class="absolute right-0 top-3 px-5">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink"
        viewBox="0 0 256.556 256.556"
        style="enable-background: new 0 0 256.556 256.556"
        xml:space="preserve"
        width="25px"
      >
        <path
          d="M230.932,25.643C214.395,9.107,192.408,0,169.021,0c-23.386,0-45.373,9.107-61.912,25.645
